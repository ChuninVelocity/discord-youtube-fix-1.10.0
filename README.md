...
# Discord Youtube Fix 1.10.0

### YouTube Unban · Discord connecting / RTC · обход DPI без VPN

**[ChuninVelocity/discord-youtube-fix-1.10.0](https://github.com/ChuninVelocity/discord-youtube-fix-1.10.0)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/ChuninVelocity/discord-youtube-fix-1.10.0/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `ChuninVelocity/discord-youtube-fix-1.10.0`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/ChuninVelocity/discord-youtube-fix-1.10.0/releases/latest) и скачайте **`.rar`** (предпочтительно)
